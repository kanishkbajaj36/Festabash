...
function TearmandCondition() {
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}getTermAndCondition`)
      .then((response) => {
        console.log(response.data.details);
        const selectedUser = response.data.details;
      ...
      <div className="container " style={{ backgroundColor: "#fff" }}>
        <div className="row m-0 ">
          <div className="col-12 my-3">
            <h4 className="text-center">This is Terms and condition page</h4>
          </div>
          <div className="col-12 my-3">
            <TextField
              fullWidth
