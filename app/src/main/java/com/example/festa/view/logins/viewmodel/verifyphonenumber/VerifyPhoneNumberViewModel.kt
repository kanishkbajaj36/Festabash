...
@HiltViewModel
class VerifyPhoneNumberViewModel @Inject constructor(application: Application, private val repository: VerifyPhoneNumberRepository):
    AndroidViewModel(application) {
    val progressIndicator = MutableLiveData<Boolean>()
    val errorResponse = MutableLiveData<Throwable>()
    val mloginResponse = MutableLiveData<Event<SendInviteResponse>>()
